...
@media (max-width:820px){
  ...
  *::-webkit-scrollbar{display:none!important;width:0!important;height:0!important}
  ...
  /* (1.4.1) an embedded fullscreen overlay (settings) additionally needs the
     host column lifted: the column's own z:60 stacking context scopes its
     descendants' z-index, so z:1000 stayed under our FAB (z:70) and portaled
     overlays (z:1000/1100) until the column itself is raised */
  body[data-mob-embed-overlay='1'] #root div[style*='grid-template-columns']>[data-dshm-col]{z-index:1200!important}
...
`;
		...
		// tapping a tool call's inspect affordance opens the details drawer
			...
			const selfCheck = setTimeout(() => {
				...
				window.__dshMobileUi = { version: "1.4.1", frameTagged: !!(frameEl && frameEl.querySelector("[data-dshm-col]")), missing };
