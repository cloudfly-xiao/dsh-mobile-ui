...
@media (max-width:820px){
  ...
  *::-webkit-scrollbar{display:none!important;width:0!important;height:0!important}
  ...
  /* (1.4.15) corner reservations, UNCONDITIONAL on phones: left 54px clears
     the FAB, right 104px clears the better-sidebar cluster (2×40px + gaps).
     The 1.4.12 gate on body[data-dsh-sidebar-collapsed] never fired — the
     live DOM does not carry that attribute in this install */
  .wSkVaW_header{padding:calc(env(safe-area-inset-top,0px) + 8px) calc(env(safe-area-inset-right,0px) + 104px) 0 54px!important}
...
`;
		...
		// tapping a tool call's inspect affordance opens the details drawer
			...
			const selfCheck = setTimeout(() => {
				...
				window.__dshMobileUi = { version: "1.4.15", frameTagged: !!(frameEl && frameEl.querySelector("[data-dshm-col]")), missing };
