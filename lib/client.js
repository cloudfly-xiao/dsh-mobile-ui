...
@media (max-width:820px){
  ...
  *::-webkit-scrollbar{display:none!important;width:0!important;height:0!important}
  ...
  /* (1.4.21) Log capsule → icon-only button: the relabel pass clears the
     text, the shipped glyph is hidden, and a custom download-log SVG
     (folded document + down arrow, 2px round stroke) is drawn via mask on
     ::after — CSS-drawn so React re-renders never fight it */
  .nL4_yW_sessionLogButton{min-width:0!important;width:32px!important;height:32px!important;padding:0!important;gap:0!important;justify-content:center!important;border-radius:10px!important}
...
`;
		...
		// tapping a tool call's inspect affordance opens the details drawer
			...
			const selfCheck = setTimeout(() => {
				...
				window.__dshMobileUi = { version: "1.4.21", frameTagged: !!(frameEl && frameEl.querySelector("[data-dshm-col]")), missing };
