...
@media (max-width:820px){
  ...
  *::-webkit-scrollbar{display:none!important;width:0!important;height:0!important}
  ...
  .nL4_yW_sessionLogButton{min-width:0!important;padding:6px 10px!important}
...
`;
		...
		function apply(ctx) {
			...
			const relabelCapsule = () => {
				...
				for (let n = walker.nextNode(); n; n = walker.nextNode())
					if (n.nodeValue === "Session log") n.nodeValue = "Log";
			};
			let labelRaf = 0;
		...
		// tapping a tool call's inspect affordance opens the details drawer
			...
			const selfCheck = setTimeout(() => {
				...
				window.__dshMobileUi = { version: "1.4.20", frameTagged: !!(frameEl && frameEl.querySelector("[data-dshm-col]")), missing };
